...
public class Main {
    public static void main(String[] args) {
        ...
        Cliente cliente1 = crearCliente(1L, "Bianca", "Perrotta", "123456789", "biancaperrotta@gmail.com", LocalDate.of(2002, 8, 27));
        Cliente cliente2 = crearCliente(2L, "Bautista", "Perino", "333344412", "bautiperino.com", LocalDate.of(2004, 5, 27));
        Cliente cliente3 = crearCliente(3L, "Carlos", "Montenegro", "123123123", "gonzlaut@gmail.com", LocalDate.of(1976, 1, 11));
        ...
        // Mostrar cantidad de compras del primer cliente
